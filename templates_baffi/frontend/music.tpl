		...
		<tr class="{cycle values=",alt"}">
			<td class="mid">
				...
				<div class="movextra">
					...
					{if $result.url != ""}<a class="rndbtn badge-amaz" target="_blank" href="{$site->dereferrer_link}{$result.url}" name="amazon{$result.musicinfoID}" title="View amazon page">Amazon</a>{/if}
