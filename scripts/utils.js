...
jQuery(function($){
	...
	$("table.data a.modal_nfo").colorbox({	 // NFO modal
		...
		innerWidth:"1000px", innerHeight:"90%", initialWidth:"1000px", initialHeight:"90%", speed:0, opacity:0.7
	});
	// Screenshot modal
	$("table.data a.modal_prev").colorbox({scrolling:false, maxWidth:"1000px", maxHeight:"650px"});
	
	$("table.data a.modal_imdb").colorbox({	 // IMDB modal
		href: function(){ return SERVERROOT + "movie/"+$(this).attr('name').substring(4)+'&modal'; },
		title: function(){ return $(this).parent().parent().children('a.title').text(); },
		innerWidth:"1000px", innerHeight:"450px", initialWidth:"1000px", initialHeight:"650px", speed:0, opacity:0.7
	}).click(function(){
	...
	$("table.data a.modal_music").colorbox({	 // Music modal
		...
		title: function(){ return $(this).parent().parent().children('a.title').text(); },
		innerWidth:"1000px", innerHeight:"650px", initialWidth:"1000px", initialHeight:"650px", speed:0, opacity:0.7
	}).click(function(){
