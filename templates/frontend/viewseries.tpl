...
<div class="tvseriesheading">
	...
	<p>
		...
		{if $seriesdescription|strlen > 1500}<span class="descfull">{$seriesdescription|escape:"htmlall"|nl2br|magicurl}</span>{else}</span>{/if}
	</p>
...
<span>
	...
	<form id="nzb_multi_operations_form" action="get">
		...
		<div class="nzb_multi_operations">
			...
			<input type="button" class="nzb_multi_operations_delete" value="Delete" />
			{/if}	
		</div>
		...
		<table style="width:100%; {if !$smarty.foreach.tv.first}display:none;{/if}" class="tb_{$seasonnum} data highlight icons table table-striped" id="browsetable">
			<tr>
